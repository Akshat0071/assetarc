    ...
    <Layout>
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pt-24 pb-12 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute w-[700px] h-[700px] bg-AssetArc-bg-light rounded-full blur-100 opacity-40 left-1/2 -translate-x-1/2 top-24" />
          <div className="absolute top-20 left-16 w-3 h-3 bg-AssetArc-green-light/30 rounded-full animate-ping" />
          <div className="absolute bottom-24 right-20 w-3 h-3 bg-AssetArc-green-accent/30 rounded-full animate-bounce" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <p className="text-white/60 text-base sm:text-lg max-w-3xl mx-auto mb-6">
            The financial world often feels overwhelming, filled with jargon, sales-driven advice, and fear of making mistakes. AssetArc was created to change that.
          ...
          <div className="inline-block px-6 py-3 bg-AssetArc-green-light/10 border border-AssetArc-green-light/30 rounded-full">
            <p className="text-AssetArc-green-light font-product-sans text-lg sm:text-xl font-medium">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 sm:p-10 hover:border-AssetArc-green-light/50 transition-colors duration-300">
            <p className="text-white/80 text-lg leading-relaxed mb-4">
              AssetArc helps young professionals, first-time investors, and families build long-term financial stability through disciplined investing, honest advice, and simple explanations.
            </p>
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 py-12 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <div className="w-full h-[400px] bg-AssetArc-bg-light blur-185 opacity-20" />
        </div>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-product-sans text-4xl sm:text-5xl font-normal uppercase mb-4">
          ...
          <div className="space-y-6">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
              <h3 className="text-2xl font-product-sans mb-4 text-AssetArc-green-light">The Beginning</h3>
              <p className="text-white/80 text-lg leading-relaxed">
                AssetArc began with a simple realisation: People genuinely want to invest, but they often feel confused and overwhelmed. Not because they lack capability, but because financial concepts were never explained in a simple, human manner. AssetArc was built to change this experience.
              </p>
            </div>

            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
              <h3 className="text-2xl font-product-sans mb-4 text-AssetArc-green-light">Our Four Principles</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-AssetArc-green-light rounded-full mt-2 shrink-0"></div>
                  <div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
              <p className="text-white/80 text-lg leading-relaxed">
                This approach has helped us earn the trust of <span className="text-AssetArc-green-light font-semibold">200+ clients</span> across India, all of whom wanted something financial services rarely offer today—Someone who listens, explains, and genuinely cares about their financial wellbeing.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-12 relative">
        <div className="absolute inset-0 -z-10">
          <div className="w-full h-[400px] bg-AssetArc-bg-light blur-185 opacity-40" />
        </div>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-product-sans text-4xl sm:text-5xl font-normal uppercase mb-4">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 sm:p-10 hover:border-AssetArc-green-light transition-colors duration-300 mb-10">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
            <p className="text-white/80 text-lg leading-relaxed">
              Our goal is to make every financial decision feel <span className="text-AssetArc-green-light font-semibold">simple, clear, and well-supported.</span>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[{
            ...
            <a
              key={s.title}
              href={s.href}
              className="block  bg-AssetArc-bg border-2 border-[#ffffff21] rounded-2xl p-6 text-left hover:border-white hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] transition-all duration-300"
            >
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
              <h3 className="text-2xl font-product-sans text-AssetArc-green-light mb-4">Simplicity</h3>
              <p className="text-white/80 text-lg leading-relaxed">
                We break down financial concepts into clear, understandable guidance.
              </p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
              <h3 className="text-2xl font-product-sans text-AssetArc-green-light mb-4">Transparency</h3>
              <p className="text-white/80 text-lg leading-relaxed">
                No unrealistic promises. No hidden conditions. Every recommendation is honest and accountable.
              </p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
              <h3 className="text-2xl font-product-sans text-AssetArc-green-light mb-4">Education-First</h3>
              <p className="text-white/80 text-lg leading-relaxed">
                We help you understand the &quot;why&quot; behind every strategy.
              </p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light/50 transition-colors duration-300">
              <h3 className="text-2xl font-product-sans text-AssetArc-green-light mb-4">Long-Term Discipline</h3>
              <p className="text-white/80 text-lg leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-product-sans text-4xl sm:text-5xl font-normal uppercase mb-4">
              ...
              <span className="gradient-text">Clients Trust AssetArc</span>
            </h2>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 sm:p-10 hover:border-AssetArc-green-light/50 transition-colors duration-300">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                <div className="w-3 h-3 bg-AssetArc-green-light rounded-full mt-2 shrink-0"></div>
                <div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 text-center relative">
        <div className="absolute inset-0 -z-10">
          <div className="w-full h-[300px] bg-AssetArc-bg-light blur-185 opacity-30" />
        </div>
        <div className="max-w-3xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-AssetArc-green-light hover:shadow-[0_0_30px_rgba(0,255,151,0.2)] transition-all duration-300">
          ...
          <p className="text-white/70 mb-6">At AssetArc, we believe every person deserves financial clarity and the confidence to take control of their future. With honest advice, simple explanations, and disciplined planning, we guide you step-by-step toward long-term financial security.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="/lets-talk" className="inline-flex items-center gap-3 px-6 py-3 bg-transparent border-2 border-white/20 rounded-full text-white hover:border-AssetArc-green-light hover:text-AssetArc-green-light hover:bg-AssetArc-green-light/10 hover:scale-110 hover:shadow-[0_0_20px_rgba(0,255,151,0.3)] transition-all duration-300 font-work-sans font-medium group">
              <div className="w-2 h-2 bg-AssetArc-green-accent rounded-full group-hover:scale-125 group-hover:animate-pulse transition-all duration-300"></div>
              Let&apos;s Talk
            </a>
          </div>
        </div>
